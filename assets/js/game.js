...
var endGame = function () {
  ...
  alert(playerInfo.name + " now has the hightest score of " + playerInfo.money + "!")
}
else {
  alert(playerInfo.name + "did not reach the high score of " + hightScore +". Maybe next time!");
}
...
var fightOrSkip = function () {
  ...
  var promptFight = window.prompt(
    "Would you like to FIGHT or SKIP?  Enter 'FIGHT' or 'SKIP' to continue."
  );
  ...
  if (promptFight === "skip") {
    ...
    var confirmSkip = window.confirm(
      "Are you sure?  It'll cost you some cheddar!!"
    );
