...
var fightOrSkip = function() {
  ...
  var promptFight = window.prompt ("Would you like to FIGHT or SKIP?  Enter 'FIGHT' or 'SKIP' to continue.")
...
promptFight=promptFight.toLocaleLowerCase()
  ...
  if(promptFight === "skip") {
    //confirm skip
    var confirmSkip = window.confirm("Are you sure?  It'll cost you some cheddar!!");
